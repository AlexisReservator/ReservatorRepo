...
//        add(new Reservation(1, "piesek", Date.from(Instant.parse("2019-01-04T15:00:00.000Z")),
//                Date.from(Instant.parse("2019-01-04T18:00:00.000Z")), 1));
//        add(new Reservation(2, "kotek", Date.from(Instant.parse("2019-01-05T15:00:00.000Z")),
//                Date.from(Instant.parse("2019-01-05T18:00:00.000Z")), 2));
//    }};
